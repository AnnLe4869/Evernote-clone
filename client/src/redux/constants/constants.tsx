...
export const UPDATE_MULTIPLE_NOTES = "UPDATE_MULTIPLE_NOTES";
...
export const UPDATE_NOTEBOOK = "RENAME_NOTEBOOK";
...
export const SET_NOTES_LOADING_STATUS = "SET_NOTES_LOADING_STATUS";
export const SET_NOTEBOOKS_LOADING_STATUS = "SET_NOTEBOOKS_LOADING_STATUS";
